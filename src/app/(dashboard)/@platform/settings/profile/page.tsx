// src/app/(dashboard)/@platform/settings/profile/page.tsx - UPDATED WITH FULL WIDTH AND NAVIGATION
'use client';

import { useState, useEffect } from 'react';
import { useAuth } from '@/context/AuthContext';
import { User, Camera, Save, Mail, Phone, Calendar, MapPin, ArrowLeft } from 'react-feather';
    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-8 space-y-6 lg:space-y-0">
            <div className="flex items-center space-x-6">
              <div className="relative">
                ...
                <label className="absolute bottom-0 right-0 bg-indigo-600 rounded-full p-3 text-white hover:bg-indigo-700 cursor-pointer">
          ...
          {/* Basic Information - Full Width Grid */}
          <div>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center pt-6 border-t border-gray-200 space-y-4 sm:space-y-0">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center justify-center px-8 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
              {loading ? (
                <>
