...
const MessageSent = () => {
  ...
  const [selectedFilter, setSelectedFilter] = useState('Message Sent');
  ...
  const contacts = [
    ...
    { name: "Giana Lipshutz", handle: "@giana", avatar: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=32&h=32&fit=crop&crop=face" },
  ];
