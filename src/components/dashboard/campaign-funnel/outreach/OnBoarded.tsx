...
const OnBoarded = () => {
  ...
  const [selectedFilter, setSelectedFilter] = useState('On Boarded');
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden relative h-[600px] flex flex-col">
      ...
      <div className="flex items-center justify-between px-3 py-2.5 border-b border-gray-100 flex-shrink-0">
        <h3 className="text-base font-semibold text-gray-900">{selectedFilter} (343)</h3>
          ...
          <div className="space-y-2">
            <label className="flex items-center justify-between cursor-pointer bg-purple-50 p-1.5 rounded-md border border-purple-200">
              ...
              <input
                ...
                name="filter"
                value="Low to High"
                checked={selectedFilter === 'Low to High'}
            ...
            <label className="flex items-center justify-between cursor-pointer bg-purple-50 p-1.5 rounded-md border border-purple-200">
              <span className="text-xs text-purple-700 font-medium">High to Low</span>
              <input
                type="radio"
                name="filter"
                value="High to Low"
                checked={selectedFilter === 'High to Low'}
                onChange={(e) => handleFilterChange(e.target.value)}
            ...
            <label className="flex items-center justify-between cursor-pointer bg-purple-50 p-1.5 rounded-md border border-purple-200">
              ...
              <input
                ...
                name="filter"
                value="Average"
                checked={selectedFilter === 'Average'}
                onChange={(e) => handleFilterChange(e.target.value)}
                className="w-3 h-3 text-blue-600 border-gray-300 focus:ring-blue-500"
              />
            </label>
      ...
      {/* Contact List with padding for button */}
